      ...
      <section className="py-24">
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          >
            <img
              src={puttingImg}
              alt="Jack Pitts putting"
              className="w-48 md:w-56 animate-float drop-shadow-xl"
              data-testid="img-registration-putting"
            />
          </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            ...
            >
              <div className="bg-[#1a6b3a] p-8 text-center text-white">
                <h3 className="text-2xl font-display font-bold mb-2 text-white">Player Entry</h3>
                <div className="flex items-baseline justify-center gap-1">
                  <span className="text-5xl font-display font-bold">$125</span>
                  <span className="text-white/80 font-body">/ person</span>
                </div>
            ...
            <div className="space-y-8">
              <div>
                <h2 className="text-3xl font-display font-bold text-[#0d1f0f] mb-4">How to Register</h2>
                <p className="text-[#0d1f0f]/60 text-lg leading-relaxed font-body">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-[#0d1f0f]/60 mt-1 font-body">
                      If you have any questions about registration or sponsorship opportunities, please email us at <a href="mailto:info@jackpittshealthfoundation.org" className="text-[#1a6b3a] hover:underline">info@jackpittshealthfoundation.org</a>
                    </p>
                  </div>
                </div>
              </div>
