        ...
        <div className="flex justify-between items-center">
          <Link href="/" className="cursor-pointer group flex items-center gap-3">
            ...
            <div className="flex flex-col">
              ...
              <span className={`text-[10px] md:text-xs font-athletic tracking-[0.2em] uppercase transition-colors duration-500 ${scrolled ? 'text-[#0d1f0f]/60' : 'text-[#f5f0e8]/70'}`}>
                Health Foundation
              </span>
            </div>
          </Link>
              ...
              <Link key={link.href} href={link.href}>
                <motion.span
                  ...
                  className={`px-4 py-2 text-sm font-body font-medium transition-all duration-300 rounded-full cursor-pointer relative ${
                    location === link.href
                      ? scrolled ? "text-[#1a6b3a] bg-[#1a6b3a]/10" : "text-[#f5f0e8] bg-[#f5f0e8]/10"
                      : scrolled ? "text-[#0d1f0f]/70 hover:text-[#1a6b3a] hover:bg-[#1a6b3a]/5" : "text-[#f5f0e8]/70 hover:text-[#f5f0e8] hover:bg-[#f5f0e8]/5"
                  }`}
              ...
              {navLinks.map((link) => (
                <Link key={link.href} href={link.href}>
                  <div
                    ...
                    className={`block px-4 py-3 rounded-md text-base font-body font-medium transition-colors cursor-pointer ${
                      location === link.href
